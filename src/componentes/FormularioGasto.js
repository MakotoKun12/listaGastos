...
const FormularioGasto = ({gasto}) => {
    ...
    const handleChange = (e) => {
        if(e.target.name === 'description'){
            ...
            //replace = para colocar una expresion resgular
    ...
    const handleSubmit = (e) => {
        ...
        if(inputDescripcion !== '' && inputCantidad !== ''){
            //Comprobamos que solo puedan introducirse cantidades 
            if(cantidad){
                if(gasto){
                    editarGasto({
                        id: gasto.id,
    ...
    return ( 
        <Formulario onSubmit={handleSubmit}>
            ...
            <div>
                <Input type='text' name='description' id='description' placeholder='Descripción' value={inputDescripcion} onChange={handleChange}/>
